...
class DataManager(object):
    ...
    def get_dataset(self, indices, source, mode, appendent=None, ret_data=False):
        ...
        # print(self._train_data.shape)  # (119894, 128, 128, 3)
        # print(self._test_data.shape)   # (44972, 128, 128, 3)
    ...
    def _setup_data(self, dataset_name, shuffle, seed):
        ...
        # Order
        order = [i for i in range(len(np.unique(self._train_targets)))] # len is only 2069, is not 2070 # has fixed
